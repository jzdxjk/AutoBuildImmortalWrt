...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-lib-ipkg luci-compat dnsmasq-full coreutils-nohup bash curl jsonfilter ca-certificates ipset ip-full iptables-mod-tproxy iptables-mod-extra libcap libcap-bin ruby ruby-yaml kmod-tun"
# VPN
